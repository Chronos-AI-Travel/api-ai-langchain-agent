...
llm = ChatOpenAI(openai_api_key="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")
...
chat_history = [
    HumanMessage(content="Can you help me integrate my codebase with Duffel Flights Search capability?"),
